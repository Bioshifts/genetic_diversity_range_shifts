...
dir.out="/home/rbertrand/W/Bioshift/GD_study/boot_analysis/REMLF2_LE" #to change. It's the repository where the results are saved
...
c1=read.csv2("coeff_LE.csv",sep=";",dec=".",h=T)
dsel=mydatatogo
