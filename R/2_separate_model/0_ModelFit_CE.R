...
dir.out="/home/rbertrand/W/Bioshift/GD_study/boot_analysis/REMLF2_CE" #to change. It's the repository where the results are saved
...
#             sep=";",dec=".",row=F) 
write.table(resCE,
            "summary_GDeff_CE.csv",
            sep=";",dec=".",row=F)
# write.table(resLE,
#             "summary_GDeff_LE.csv",
#             sep=";",dec=".",row=F)
...
c1=read.csv2("coeff_CE.csv",sep=";",dec=".",h=T)
dsel=mydatatogo
...
#             sep=";",dec=".",row=F) 
# write.table(resLE,
#             "summary_VAeff_LE.csv",
#             sep=";",dec=".",row=F)
write.table(resCE,
            "summary_VAeff_CE.csv",
            sep=";",dec=".",row=F)
