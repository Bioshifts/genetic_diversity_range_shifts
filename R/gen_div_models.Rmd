...
mydataset <- read.csv("Data/gen_data_final_m5.csv")
...
model_data$He <- as.numeric(model_data$He_harm)
# define the shift metric to go
model_data$SHIFT <- as.numeric(model_data$SHIFT_abs)

bestmodel <- glmmTMB(SHIFT_abs ~ 
                         # Fixed effects
                         ## Ecology
...
plot(tmp$`velocity_abs:He:Param`)
...
# define the He metric to go
model_data$He <- as.numeric(model_data$He_harm2)
...
mydatatogo$SHIFTnew <- mydatatogo$SHIFT_raw
...
# define the He metric to go
model_data$He <- as.numeric(scale(model_data$He_harm2))
# define the lag metric to go
