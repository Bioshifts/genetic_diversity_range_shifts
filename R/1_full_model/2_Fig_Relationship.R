...
################################################################################
#####################Fig. v2: adding obs as background with latitudinal gradient
################################################################################
rampPallFunGD <- function(x){
    tmp <- colorRampPalette(colors = c("#00AFBB", "#E7B800", "#FC4E07"))(length(x))
    return(tmp)
...
################################################################################
#####################Fig. v3: adding obs as background##########################
################################################################################
###############exploring the climate change dependence of the genetic diversity effect 
rampPallFunGD <- function(x){
    tmp <- colorRampPalette(colors = c("#00AFBB", "#E7B800", "#FC4E07"))(length(x))
...
summary(t1$Lat)
gg1 <- ggplot()+
    geom_point(data=t1,aes(x=GD,y=SHIFT_abs),alpha=6/10,color="grey80")+
    GD_graph_params1 +
    scale_y_continuous(breaks = seq(0,50,by=10), 
                       limits=c(0,34), 
                       expand=c(0,0))+
...
png(paste0(dir.out,"/fig3_VICeffectOnGD_v3.png"),unit="cm",width=27,height=11,res=300)#,width=547,height=360
(p1a + p2a + p3a + gg_lega ) + 
    plot_layout( nrow = 1, widths = c(1,1,1,0.4)) #+ # common axes => add axis_titles = "collect"
#plot_annotation(tag_levels = list(c('(a)','(b)','(c)',''))) # figure tags
dev.off()
...
summary(t1$Lat)
gg1 <- ggplot()+
    geom_point(data=t1,aes(x=vel_abs,y=SHIFT_abs),alpha=6/10,color="grey80")+
    GD_graph_params1 +
    scale_y_continuous(breaks = seq(0,50,by=10), 
                       limits=c(0,34), 
                       expand=c(0,0))+
...
#formatting chart
gg4 <- ggplot(data=predX1, aes(vel_abs, pred1, color = GD, group=ID)) +
    GD_graph_params +
    scale_color_viridis(name = bquote("Genetic diversity"), 
                        guide = guide_colourbar(title.position = "right",barwidth = 1,barheight = 15),
                        limits=c(0, 0.055),
...
png(paste0(dir.out,"/fig3_GDeffectOnVIC_v3.png"),unit="cm",width=27,height=11,res=300)#,width=547,height=360
(p1 + p2 + p3 + gg_leg ) + 
    plot_layout(nrow = 1, widths = c(1,1,1,0.4)) #+ # common axes => add axis_titles = "collect"
#plot_annotation(tag_levels = list(c('(a)','(b)','(c)','(d)'))) # figure tags
dev.off()
...
################################################################################
#####################Fig. v4: obs density map as background#####################
################################################################################
################################################################################
...
GD_graph_params2 <- 
    list(labs(color = bquote('Climate change velocity '(km.yr^-1))),  
         theme_classic(),  
         theme(legend.title = element_text(angle = -90), 
               legend.title.align = 0.5))
...
dsel$ra=round(dsel$SHIFT_abs,1)
kd <- with(dsel, MASS::kde2d(GD2,ra, n = 50,lims=c(round(range(mydatatogo$GD),4),round(range(mydatatogo$SHIFT_abs),1))))
...
r1_df$n2=r1_df$n
r1_df$n2[r1_df$n==0]=NA
gg=ggplot()  
gg <- gg + geom_tile(data = r1_df, aes(x =GD, y = vel_abs, fill = n2),color="grey", size=0.1)
#gg<-  gg + theme_minimal()
# gg <- gg + scale_fill_viridis(option="B",
#                               name = stringr::str_wrap("Number of observations"),
#                               guide = guide_colourbar(title.position = "right",barwidth = 1,barheight = 15),
#                               limits=c(0.1, 70),
#                               breaks=c(1,seq(10,70,by=10)),
#                               na.value = "white",
#                               direction=-1)
gg <- gg +  scale_fill_continuous(low = "grey80", high = "black",
...
gg <- gg + labs(x="Genetic diversity", y=bquote("Velocity of range shift (°C.yr<sup>-1</sup>)"), title="")
...
gg1=gg1+new_scale_colour() +
    ...
    scale_color_gradientn(colors = rampPallFunGD(sigcolor$x),
                          ...
                          limits=c(0, 7),
                          breaks=c(seq(0,7,by=1))) 
gg1 <- gg1 + scale_x_continuous(breaks=seq(0,0.025,by=0.005),limits=c(-0.001,0.0265),expand=c(0,0),labels=c(0,seq(0.005,0.025,by=0.005)))
gg1 <- gg1 + scale_y_continuous(breaks=seq(0,30,by=10),limits=c(-1,35),expand=c(0,0))
gg1 <- gg1 + theme(axis.text=element_text(size=10))
gg1 <- gg1 + theme(axis.text.x=element_text(vjust=1))
gg1 <- gg1 + theme(axis.title.x = element_text(margin = margin(t = 8,b=0),size=11))
gg1 <- gg1 + theme(axis.title.y = element_markdown(margin = margin(r =10),size=11))
gg1
...
gg2=gg2+new_scale_colour() +
    ...
    scale_color_gradientn(colors = rampPallFunGD(sigcolor$x),
                          ...
                          limits=c(0, 7),
                          breaks=c(seq(0,7,by=1)))  
gg2 <- gg2 + scale_x_continuous(breaks=seq(0,0.05,by=0.01),limits=c(-0.0015,0.052),expand=c(0,0),labels=c(0,seq(0.01,0.05,by=0.01)))
gg2 <- gg2 + scale_y_continuous(breaks=seq(0,40,by=10),limits=c(-1.2,45),expand=c(0,0))
gg2 <- gg2 + theme(axis.text=element_text(size=10))
gg2 <- gg2 + theme(axis.text.x=element_text(vjust=1))
gg2 <- gg2 + theme(axis.title.x = element_text(margin = margin(t = 8,b=0),size=11))
gg2 <- gg2 + theme(axis.title.y = element_markdown(margin = margin(r =10),size=11))
gg2
...
gg <- gg +  scale_fill_continuous(low = "grey80", high = "black",
                                  name = stringr::str_wrap("Density of observations"),
                                  guide = guide_colourbar(title.position = "right",barwidth = 1,barheight = 7),
                                  limits=c(0.0001, 70),
                                  breaks=c(1,seq(10,70,by=10)),
                                  na.value = "white")
...
gg3=gg3+new_scale_colour() +
    ...
    scale_color_gradientn(colors = rampPallFunGD(sigcolor$x),
                          ...
                          limits=c(0, 7),
                          breaks=c(seq(0,7,by=1)))  
gg3 <- gg3 + scale_x_continuous(breaks=seq(0,0.05,by=0.01),limits=c(-0.0012,0.056),expand=c(0,0),labels=c(0,seq(0.01,0.05,by=0.01)))
gg3 <- gg3 + scale_y_continuous(breaks=seq(0,50,by=10),limits=c(-1.2,55),expand=c(0,0))
gg3 <- gg3 + theme(axis.text=element_text(size=10))
gg3 <- gg3 + theme(axis.text.x=element_text(vjust=1))
gg3 <- gg3 + theme(axis.title.x = element_text(margin = margin(t = 8,b=0),size=11))
gg3 <- gg3 + theme(axis.title.y = element_markdown(margin = margin(r =10),size=11))
gg3
...
png(paste0(dir.out,"/fig3_VICeffectOnGD_v4.png"),unit="cm",width=27,height=11,res=300)#,width=547,height=360
(p1a + p2a + p3a) + 
    plot_layout( nrow = 1, widths = c(1,1,1)) #+ # common axes => add axis_titles = "collect"
#plot_annotation(tag_levels = list(c('(a)','(b)','(c)',''))) # figure tags
dev.off()
...
dsel$GD2=round(dsel$vel_abs,1)
dsel$ra=round(dsel$SHIFT_abs,1)
kd <- with(dsel, MASS::kde2d(GD2,ra, n = 50,lims=c(round(range(mydatatogo$vel_abs),1),round(range(mydatatogo$SHIFT_abs),1))))
...
gg <- gg +  scale_fill_continuous(low = "grey80", high = "black",
                                  ...
                                  breaks=c(0.01,seq(0.05,0.25,by=0.05)),
                                  na.value = "white")

gg <- gg + labs(x=bquote("Climate change velocity (°C.yr<sup>-1</sup>)"), y=bquote("Velocity of range shift (°C.yr<sup>-1</sup>)"), title="")
gg <- gg + theme_tufte(base_size=11,base_family="Helvetica")
gg <- gg + theme(plot.title=element_text(hjust=0.5))
gg <- gg + theme(axis.ticks=element_blank())
gg <- gg + coord_cartesian(expand = FALSE)
...
gg1=gg1+new_scale_colour() +
    ...
    scale_color_viridis(name = bquote("Genetic diversity"), 
                        ...
                        limits=c(0, 0.055),
                        breaks=c(seq(0,0.05,by=0.01)))
gg1 <- gg1 + scale_x_continuous(breaks = seq(0,5,by=1), 
                                limits=c(0,5.8), 
                                expand=c(0,0))
gg1 <- gg1 + scale_y_continuous(breaks=seq(0,30,by=10),limits=c(-1,35),expand=c(0,0))
gg1 <- gg1 + theme(axis.text=element_text(size=10))
gg1 <- gg1 + theme(axis.text.x=element_text(vjust=1))
gg1 <- gg1 + theme(axis.title.x = element_markdown(margin = margin(t = 8,b=0),size=11))
gg1 <- gg1 + theme(axis.title.y = element_markdown(margin = margin(r =10),size=11))
...
gg2=gg2+new_scale_colour() +
    ...
    scale_color_viridis(name = bquote("Genetic diversity"), 
                        ...
                        limits=c(0, 0.055),
                        breaks=c(seq(0,0.05,by=0.01)))
gg2 <- gg2 + scale_x_continuous(breaks = seq(0,7,by=1), 
                                limits=c(0,7), 
                                expand=c(0,0))
gg2 <- gg2 + scale_y_continuous(breaks=seq(0,40,by=10),limits=c(-1,45),expand=c(0,0))
gg2 <- gg2 + theme(axis.text=element_text(size=10))
gg2 <- gg2 + theme(axis.text.x=element_text(vjust=1))
gg2 <- gg2 + theme(axis.title.x = element_markdown(margin = margin(t = 8,b=0),size=11))
gg2 <- gg2 + theme(axis.title.y = element_markdown(margin = margin(r =10),size=11))
gg2
...
gg3=gg3+new_scale_colour() +
    ...
    scale_color_viridis(name = bquote("Genetic diversity"), 
                        ...
                        limits=c(0, 0.055),
                        breaks=c(seq(0,0.05,by=0.01)))
gg3 <- gg3 + scale_x_continuous(breaks = seq(0,7,by=1), 
                                limits=c(-0.13,6), 
                                expand=c(0,0))
gg3 <- gg3 + scale_y_continuous(breaks=seq(0,50,by=10),limits=c(-1,55),expand=c(0,0))
gg3 <- gg3 + theme(axis.text=element_text(size=10))
gg3 <- gg3 + theme(axis.text.x=element_text(vjust=1))
gg3 <- gg3 + theme(axis.title.x = element_markdown(margin = margin(t = 8,b=0),size=11))
gg3 <- gg3 + theme(axis.title.y = element_markdown(margin = margin(r =10),size=11))
gg3
...
png(paste0(dir.out,"/fig3_GDeffectOnVIC_v4.png"),unit="cm",width=27,height=11,res=300)#,width=547,height=360
(p1 + p2 + p3) + 
    plot_layout(nrow = 1, widths = c(1,1,1)) #+ # common axes => add axis_titles = "collect"
#plot_annotation(tag_levels = list(c('(a)','(b)','(c)','(d)'))) # figure tags
dev.off()
