...
**Genetic data**  
- He = heteroziogosite measurements from multiple data sources (DeKort et al 2021, Nature Communications; Lawrence and Fraser 2020, Global Ecology and Biogeography; Malin, Unpublished).  
...
model_data$He <- model_data$He_harm2
# define the lag metric to go
model_data$lag <- model_data$lagC2
