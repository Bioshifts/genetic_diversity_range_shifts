...
if(get_raster_bioshifts=="YES"){
  ...
  writeRaster(rast_biov1, here::here("Data/raster_bioshifts_SA_pop-level.tif"), overwrite = TRUE)
  
} else {
  rast_biov1 <- terra::rast(here::here("Data/raster_bioshifts_SA_pop-level.tif"))
